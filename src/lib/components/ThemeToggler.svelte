...
<button
    class="fixed bottom-4 right-4 h-11 w-11 z-50 flex justify-center items-center rounded-full border border-[var(--border-subtle)] bg-[var(--bg-elevated)] text-[var(--accent)] hover:shadow-[0_18px_55px_rgba(249,115,22,0.6)] transition-all"
        ...
        <svg
            ...
            ><g
                ...
                ><path
                    ...
                    opacity="0"
                    ><set fill="freeze" attributeName="opacity" begin="0.5s" to="1" /></path
                ></g
            ><mask id="SVGBsVgBdfm"
            ...
            ><circle cx="12" cy="12" r="6" mask="url(#SVGBsVgBdfm)" fill="currentColor"
                ><animate
                    ...
                    dur="0.4s"
                    values="6;10"
                /><set fill="freeze" attributeName="opacity" begin="0.5s" to="0" /></circle
            ></svg
        >
    {/if}
</button>
